...
```javascript
import binary4d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-binary4d@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-binary4d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-binary4d/actions/workflows/test.yml?query=branch:v0.2.3
